...
export default function HeroSection() {
  return (
    <section className="relative bg-white overflow-hidden">
      ...
      <div
        className="absolute -top-64 -right-40 w-[720px] h-[720px] rounded-full bg-gradient-to-br from-brand-blue/15 via-brand-blueLight/10 to-transparent blur-3xl pointer-events-none animate-drift"
        aria-hidden="true"
      />
      <div
        className="absolute top-40 -left-48 w-[560px] h-[560px] rounded-full bg-gradient-to-tr from-brand-gold/10 via-brand-goldSoft/10 to-transparent blur-3xl pointer-events-none animate-drift"
        style={{ animationDelay: "-6s" }}
        aria-hidden="true"
      />
      <div
        className="absolute bottom-0 right-1/3 w-[420px] h-[420px] rounded-full bg-brand-navy/5 blur-3xl pointer-events-none animate-drift"
      ...
      <div className="relative mx-auto max-w-7xl px-6 pt-16 pb-12 lg:pt-24 lg:pb-20">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          {/* Left content */}
          <div className="lg:col-span-7 relative z-10">
            <Reveal>
              <div className="inline-flex items-center gap-3 rounded-full bg-brand-blue/8 ring-1 ring-brand-blue/15 pl-2 pr-4 py-1.5">
                ...
                <span className="text-[12px] font-semibold uppercase tracking-[0.18em] text-brand-navyDark">
            ...
            <Reveal delay={120}>
              <h1 className="section-title mt-7 text-[44px] sm:text-6xl lg:text-[88px] leading-[0.95] text-brand-navyDark font-semibold tracking-tight">
                Take your next
                <br />
                step toward{" "}
                <span className="relative inline-block">
                  <span className="relative z-10 italic text-brand-blue">
                    better
                  </span>
                  <svg
                ...
                <span className="italic text-brand-blue">health.</span>
              </h1>
            </Reveal>

            <Reveal delay={220}>
              <p className="mt-7 max-w-xl text-base sm:text-lg text-brand-textLight leading-relaxed">
            ...
            <Reveal delay={320}>
              <div className="mt-9 flex flex-col sm:flex-row gap-3 sm:gap-4 sm:items-center">
                <Link
                  href="/schedule/"
                  className="group/cta relative inline-flex items-center gap-2 bg-brand-navyDark text-white rounded-full pl-7 pr-2 py-2 text-sm font-semibold overflow-hidden hover:bg-brand-blue transition-colors shadow-[0_10px_30px_-10px_rgba(13,35,64,0.5)]"
                >
                  <span className="relative z-10">Book Appointment</span>
                  <span className="relative z-10 inline-flex h-9 w-9 items-center justify-center rounded-full bg-brand-gold text-brand-navyDark group-hover/cta:bg-white group-hover/cta:text-brand-blue transition-colors">
                ...
                >
                  <span className="inline-flex h-11 w-11 items-center justify-center rounded-full bg-white ring-1 ring-brand-navyDark/15 group-hover:ring-brand-blue group-hover:bg-brand-blue/5 transition-all">
                    <PlayIcon className="w-3.5 h-3.5 text-brand-blue ml-0.5" />
                  </span>
              ...
              <div className="mt-10 flex items-center gap-4">
                <div className="flex -space-x-2">
                  {[0, 1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="h-9 w-9 rounded-full ring-2 ring-white bg-gradient-to-br shadow-sm"
                      style={{
                        background:
                          i === 0
            ...
            <Reveal delay={200} variant="fade">
              <div className="relative mx-auto max-w-md lg:max-w-none">
                ...
                >
                  <svg
                    viewBox="0 0 200 200"
                    className="w-full h-full text-brand-gold animate-spinSlow"
                  >
                ...
                <div
                  className="absolute -inset-3 rounded-[36px] bg-brand-gold/30 -rotate-3"
                  aria-hidden="true"
                />
                {/* Blue tilted plate behind */}
                <div
                  className="absolute -inset-1 rounded-[32px] bg-brand-blue/15 rotate-2"
                  aria-hidden="true"
                />

                {/* Main image card */}
                <div className="relative aspect-[4/5] rounded-[28px] overflow-hidden shadow-[0_30px_80px_-20px_rgba(13,35,64,0.45)] ring-1 ring-black/5">
                  <Image
                    src={HERO_IMAGE}
                ...
                <div
                  className="hidden sm:flex absolute -left-10 top-1/2 -translate-y-1/2 h-14 w-14 items-center justify-center rounded-2xl bg-brand-navyDark text-brand-gold shadow-xl rotate-[-6deg] animate-float"
        ...
        {/* Stats strip */}
        <div className="mt-16 lg:mt-24 grid grid-cols-1 sm:grid-cols-3 rounded-3xl bg-gradient-to-br from-brand-navyDark via-brand-navy to-brand-navyDark p-1 shadow-[0_30px_80px_-30px_rgba(13,35,64,0.5)] relative overflow-hidden">
          {/* Inner shine */}
          <div
      ...
      {/* Marquee at bottom */}
      <div className="relative border-y border-brand-navyDark/10 bg-white/40 backdrop-blur-sm py-5 overflow-hidden">
        <div className="flex animate-marquee whitespace-nowrap">
          {[...MARQUEE_WORDS, ...MARQUEE_WORDS].map((word, i) => (
            <span
              key={i}
              className="section-title text-3xl md:text-4xl font-semibold text-brand-navyDark/80 inline-flex items-center px-8"
            >
              {word}
              <span
