...
const CANONICAL = "https://synergyspineandnerve.com/promo-videos/";
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Promo Videos", item: CANONICAL },
  ],
};
        ...
        <section className="bg-brand-bg py-16">
          <div className="mx-auto max-w-5xl px-6 grid sm:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="mt-2 font-semibold text-brand-navyDark">Other Videos</p>
            </Link>
          </div>
        </section>
